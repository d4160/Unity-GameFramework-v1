namespace d4160.GameFramework
{
    ...
    public abstract class AppSettingsDataSerializationAdapter<T1, T2> : IDataSerializationAdapter where T1 : class, IGenericSerialiableData, new() where T2 : class, ISerializableData, new()
    {

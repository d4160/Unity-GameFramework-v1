namespace DefaultGame
{
    ...
    public class DefaultCreditsLauncher : LevelLauncher
#if UNITY_EDITOR
        , IWorldSceneNames, ILevelSceneNames
#endif
    {
        [SerializeField] protected WorldScene m_worldScene;
        [SerializeField] protected LevelScene m_creditsScene;
        ...
        public string[] LevelSceneNames => GameFrameworkSettings.GameDatabase.GetGameData<DefaultLevelCategoriesSO>(3).GetSceneNames(m_creditsScene.levelCategory);
        #endregion
#endif
        ...
        {
            var buildIndex = GameFrameworkSettings.GameDatabase.GetGameData<DefaultLevelCategoriesSO>(3).GetSceneBuildIndex(m_creditsScene);

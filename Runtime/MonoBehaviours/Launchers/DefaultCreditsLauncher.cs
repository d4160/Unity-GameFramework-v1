namespace DefaultGame
{
...
#endif
    {
        ...
        public string[] LevelSceneNames => GameFrameworkSettings.Database.GetGameData<DefaultLevelCategoriesSO>(3).GetSceneNames(m_creditsScene.levelCategory);
        #endregion
#endif
        ...
        {
            var buildIndex = GameFrameworkSettings.Database.GetGameData<DefaultLevelCategoriesSO>(3).GetSceneBuildIndex(m_creditsScene);
